...
//			System.out.println("적 좌표: " + enemy.getX() + ", " + enemy.getY());
			...
			Color middleBottomColor = new Color(image.getRGB(enemy.getX() + 25, enemy.getY() + 50 + 5));
...
//			
//			
//			if(middleBottomColor.getRed() == 255 && (leftColor.getRed() == 255 || rightColor.getRed() == 255)) {
//				if(enemy.getPattern() != EnemyPattern.HOME)
